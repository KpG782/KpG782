...
I'm a Computer Science student specializing in building modern, scalable web and mobile applications. I focus on creating intelligent solutions that combine clean architecture, intuitive user experiences, and cutting-edge technology. Currently expanding my expertise through DataCamp's Data Engineering scholarship program to bridge software development with data science.
...
### PaceBeats
**IoT-Powered Music Recommendation System**

Real-time music recommendation system for runners that adapts to pace and heart rate data.

**Tech Stack:** React Native, Kotlin, IoT, Spotify API, Health Connect, AppWrite

**Highlights:**
- Real-time sensor data integration
- Dynamic music adaptation algorithm
- Cross-platform mobile application
- 1st Runner Up - InfoTech Olympics 2024
